...
import AntiV from '../HomeComp/antivirus-img.png'
import Gar from '../HomeComp/guaranteed.png'
import SayNo from '../HomeComp/say-no.png'
import Fast from '../HomeComp/fast.png'
...
const QuinnQuote = () => {
  ...
  function handleQFormSubmit() {
    ...
    if (document.getElementById('zip').value === "") {
      setError("Please fill in your zipcode")
      return
    }
    ...
    var qFormData = {
      ...
      "requested_coverage": {
        "coverage_type": document.getElementById('coverage-type').value,
    ...
    fetch('https://www.nextinsure.com/listingdisplay/listings', {
      ...
      .then(data => {
        if (data.listings === '') {
          window.location.href = '/thanks-q'
        }
        console.log(data)
        localStorage.setItem('quinnLifeData', JSON.stringify(data))
        window.location.href = '/thanks-q'
      })
  }
    ...
    <div>
      ...
      <div className="header">
        <div className="form">
          ...
          <button onClick={handleQFormSubmit} className="submit-btn">Submit</button>
          <br />
